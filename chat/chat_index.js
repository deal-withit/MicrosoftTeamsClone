window.onload = function() {
    ...
    var firebaseConfig = {
      ...
      projectId: "teamclone-2244e",
      storageBucket: "teamclone-2244e.appspot.com",
      messagingSenderId: "620865144360",
      appId: "1:620865144360:web:7234c5e0a50e9367d4d71d",
      measurementId: "G-Z8X02FYYW3"
    };
  ...
  class CHAT_APP{
    ...
    create_title(){
      ...
      title.textContent = 'Microsoft Teams Chat'
    ...
    create_join_form(){
      ...
      join_input.placeholder = 'Enter Your name to Joint the Chat room'
    ...
    create_chat(){
      var parent = this;
      // Microsoft Teams Chat header is here
      ...
      chat_logout.textContent = `${localStorage.getItem('name')} || Leave the Chat Room`
